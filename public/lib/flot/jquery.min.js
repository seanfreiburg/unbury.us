...
(function (aY, H) {
    ...
    var a = (function () {
        ...
        bn.fn = bn.prototype = {constructor: bn, init: function (bI, bM, bL) {
            var bK, bN, bJ, bO;
            if (!bI) {
                return this
            }
        ...
        }, push: bi, sort: [].sort, splice: [].splice};
        ...
        bn.extend({noConflict: function (bI) {
            aY.$ = bp;
            if (bI) {
                aY.jQuery = bD
            }
            return bn
        }, isReady: false, readyWait: 1, ready: function (bI) {
            if (bI === true) {
                bn.readyWait--
            }
            ...
            if (bK && bv.test(bK)) {
                var bJ = al.head || al.getElementsByTagName("head")[0] || al.documentElement, bI = al.createElement("script");
        ...
        }, guid: 1, proxy: function (bK, bJ, bI) {
            ...
            var bL = [], bM, bJ, bK, bI = {done: function () {
                if (!bK) {
            ...
            bn.extend(bI, {then: function (bN, bM) {
                bI.done(bN).fail(bM);
                return this
            }, fail: bL.done, rejectWith: bL.resolveWith, reject: bL.resolve, isRejected: bL.isResolved, promise: function (bN) {
                if (bN == null) {
                    if (bK) {
                        return bK
                    }
            ...
            var bO = arguments.length, bI = bO <= 1 && bJ && bn.isFunction(bJ.promise) ? bJ : bn.Deferred(), bM = bI.promise();
            if (bO > 1) {
                var bN = bt.call(arguments, 0), bL = bO, bK = function (bP) {
                    return function (bQ) {
    ...
    (function () {
        ...
        a.support.scriptEval = function () {
            if (bf === null) {
                var bo = al.documentElement, bp = al.createElement("script"), br = "script" + a.now();
                try {
        ...
        a(function () {
            var bp = al.createElement("div"), e = al.getElementsByTagName("body")[0];
            if (!e) {
                return
            }
    ...
    a.extend({cache: {}, uuid: 0, expando: "jQuery" + (a.fn.jquery + Math.random()).replace(/\D/g, ""), noData: {embed: true, object: "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000", applet: true}, hasData: function (e) {
        ...
        var bj = a.expando, bk = bg.nodeType, bd = bk ? a.cache : bg, bf = bk ? bg[a.expando] : a.expando;
        if (!bd[bf]) {
            return
        }
        if (be) {
    ...
    a.fn.extend({data: function (bg, bi) {
        var bh = null;
    ...
    a.extend({queue: function (bd, e, bf) {
        if (!bd) {
            return
        }
        e = (e || "fx") + "queue";
    ...
    a.fn.extend({queue: function (e, bd) {
        if (typeof e !== "string") {
            bd = e;
            e = "fx"
        }
    ...
    a.fn.extend({attr: function (e, bd) {
    ...
    a.extend({attrFn: {val: true, css: true, html: true, text: true, data: true, width: true, height: true, offset: true}, attr: function (bd, e, bi, bl) {
    ...
    var aP = /\.(.*)$/, a0 = /^(?:textarea|input|select)$/i, K = /\./g, aa = / /g, aw = /[^\w\s.|`]/g, E = function (e) {
        return e.replace(aw, "\\$&")
    };
    a.event = {add: function (bg, bk, br, bi) {
        ...
        var bo, bh = 0, bd;
        while ((bo = bk[bh++])) {
            bp = be ? a.extend({}, be) : {handler: br, data: bi};
            if (bo.indexOf(".") > -1) {
                bd = bo.split(".");
                bo = bd.shift();
        ...
        bg = null
    }, global: {}, remove: function (br, bm, be, bi) {
        ...
        return bf
    }, guid: 100000000, proxy: a.proxy, special: {ready: {setup: a.bindReady, teardown: a.noop}, live: {add: function (e) {
        a.event.add(this, n(e.origType, e.selector), a.extend({}, e, {handler: af, guid: e.handler.guid}))
    }, remove: function (e) {
        a.event.remove(this, n(e.origType, e.selector), e)
    }}, beforeunload: {setup: function (be, bd, e) {
        if (a.isWindow(this)) {
    ...
    }, isDefaultPrevented: a5, isPropagationStopped: a5, isImmediatePropagationStopped: a5};
    var Z = function (be) {
    ...
    a.each({mouseenter: "mouseover", mouseleave: "mouseout"}, function (bd, e) {
        a.event.special[bd] = {setup: function (be) {
    ...
    if (!a.support.submitBubbles) {
        a.event.special.submit = {setup: function (bd, e) {
    ...
    if (!a.support.changeBubbles) {
        ...
        a.event.special.change = {filters: {focusout: X, beforedeactivate: X, click: function (bf) {
    ...
    if (al.addEventListener) {
        a.each({focus: "focusin", blur: "focusout"}, function (be, e) {
    ...
    a.fn.extend({unbind: function (bg, bf) {
    ...
    var aH = {focus: "focusin", blur: "focusout", mouseenter: "mouseover", mouseleave: "mouseout"};
            ...
            while ((bo = bn[bl++]) != null) {
                ...
                if (e === "live") {
                    for (var bj = 0, bh = be.length; bj < bh; bj++) {
                        a.event.add(be[bj], "live." + n(bo, bi), {data: bk, selector: bi, handler: bp, origType: bo, origHandler: bp, preType: br})
                    }
                } else {
        ...
        for (bo = 0, bl = bh.length; bo < bl; bo++) {
            ...
            for (bm = 0; bm < be.length; bm++) {
                ...
                if (bj.selector === e.selector && (!bi || bi.test(e.namespace)) && !bj.elem.disabled) {
                    ...
                    if (!bt || bt !== bp) {
                        bq.push({elem: bp, handleObj: e, level: bj.level})
                    }
                }
            }
        }
    ...
    (function () {
        ...
        var bf = function (bA, e, bD, bE) {
            ...
            if (bB.length > 1 && bj.exec(bA)) {
                ...
                if (e) {
                    bH = bE ? {expr: bB.pop(), set: bl(bE)} : bf.find(bB.pop(), bB.length === 1 && (bB[0] === "~" || bB[0] === "+") && e.parentNode ? e.parentNode : e, by);
        ...
        var bk = bf.selectors = {order: ["ID", "NAME", "TAG"], match: {ID: /#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/, CLASS: /\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/, NAME: /\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/, ATTR: /\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/, TAG: /^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/, CHILD: /:(only|nth|last|first)-child(?:\(\s*(even|odd|(?:[+\-]?\d+|(?:[+\-]?\d*)?n\s*(?:[+\-]\s*\d+)?))\s*\))?/, POS: /:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/, PSEUDO: /:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/}, leftMatch: {}, attrMap: {"class": "className", "for": "htmlFor"}, attrHandle: {href: function (e) {
            return e.getAttribute("href")
        }, type: function (e) {
            return e.getAttribute("type")
        }}, relative: {"+": function (bB, bw) {
            var by = typeof bw === "string", bA = by && !bv.test(bw), bC = by && !bA;
            if (bA) {
                bw = bw.toLowerCase()
            }
        ...
        }}, preFilter: {CLASS: function (by, bw, bx, e, bB, bC) {
            by = " " + by[1].replace(bp, "") + " ";
            if (bC) {
                return by
            }
        ...
        }}, setFilters: {first: function (bw, e) {
            return e === 0
            ...
            return e[3] - 0 === bw
        }}, filter: {PSEUDO: function (bx, bC, bB, bD) {
            ...
            var bx = by[1], e = bk.attrHandle[bx] ? bk.attrHandle[bx](bA) : bA[bx] != null ? bA[bx] : bA.getAttribute(bx), bB = e + "", bz = by[2], bw = by[4];
        ...
        (function () {
            var bw = al.createElement("div"), bx = "script" + (new Date()).getTime(), e = al.documentElement;
                    ...
                    if (!bI && !bf.isXML(bA)) {
                        ...
                        if (bA.nodeType === 9) {
                            ...
                            if (bA.nodeType === 1 && bA.nodeName.toLowerCase() !== "object") {
                                var bB = bA, bC = bA.getAttribute("id"), bz = bC || bx, bL = bA.parentNode, bK = /^\s*[+~]/.test(bJ);
                                if (!bC) {
        ...
        (function () {
            var e = al.documentElement, bx = e.matchesSelector || e.mozMatchesSelector || e.webkitMatchesSelector || e.msMatchesSelector, bw = false;
            try {
    ...
    var W = /Until$/, ai = /^(?:parents|prevUntil|prevAll)/, aW = /,/, a9 = /^.[^:#\[\.,]*$/, M = Array.prototype.slice, F = a.expr.match.POS, ao = {children: true, contents: true, next: true, prev: true};
    a.fn.extend({find: function (e) {
                ...
                while (bl && bl.ownerDocument && bl !== bd) {
                    for (bf in bh) {
                        ...
                        if (bi.jquery ? bi.index(bl) > -1 : a(bl).is(bi)) {
                            bj.push({selector: bf, elem: bl, level: e})
                        }
                    }
                    bl = bl.parentNode;
                    e++
        ...
        var bf = typeof e === "string" ? a(e, bd) : a.makeArray(e), be = a.merge(this.get(), bf);
    ...
    a.extend({filter: function (be, e, bd) {
        if (bd) {
            be = ":not(" + be + ")"
        }
    ...
    a.buildFragment = function (bh, bf, bd) {
        ...
        return{fragment: bg, cacheable: e}
    };
    a.fragments = {};
    a.each({appendTo: "append", prependTo: "prepend", insertBefore: "before", insertAfter: "after", replaceAll: "replaceWith"}, function (e, bd) {
        a.fn[e] = function (be) {
            var bh = [], bk = a(be), bj = this.length === 1 && this[0].parentNode;
    ...
    a.extend({clone: function (bg, bi, be) {
        ...
        for (var bm = 0, bh; (bh = be[bm]) != null; bm++) {
            ...
            if (typeof bh === "string" && !T.test(bh)) {
                ...
                if (typeof bh === "string") {
                    ...
                    if (!a.support.tbody) {
                        var e = v.test(bh), bk = bp === "table" && !e ? bd.firstChild && bd.firstChild.childNodes : bf[1] === "<table>" && !e ? bd.childNodes : [];
    ...
    function a8(e, bd) {
        if (bd.src) {
            a.ajax({url: bd.src, async: false, dataType: "script"})
        } else {
    ...
    var ae = /alpha\([^)]*\)/i, ak = /opacity=([^)]*)/, aM = /-([a-z])/ig, y = /([A-Z])/g, aZ = /^-?\d+(?:px)?$/i, a7 = /^-?\d/, aV = {position: "absolute", visibility: "hidden", display: "block"}, ag = ["Left", "Right"], aR = ["Top", "Bottom"], U, ay, aL, l = function (e, bd) {
    ...
    a.extend({cssHooks: {opacity: {get: function (be, bd) {
        if (bd) {
    ...
    }}}, cssNumber: {zIndex: true, fontWeight: true, opacity: true, zoom: true, lineHeight: true}, cssProps: {"float": a.support.cssFloat ? "cssFloat" : "styleFloat"}, style: function (bf, be, bk, bg) {
    ...
    a.each(["height", "width"], function (bd, e) {
        a.cssHooks[e] = {get: function (bg, bf, be) {
            var bh;
            if (bf) {
                if (bg.offsetWidth !== 0) {
                    bh = o(bg, e, be)
    ...
    if (!a.support.opacity) {
        a.cssHooks.opacity = {get: function (bd, e) {
    ...
    U = ay || aL;
    function o(be, bd, e) {
        var bg = bd === "width" ? ag : aR, bf = bd === "width" ? be.offsetWidth : be.offsetHeight;
        if (e === "border") {
            return bf
        }
        a.each(bg, function () {
    ...
    a.fn.extend({load: function (be, bh, bi) {
        ...
        var bd = this;
        a.ajax({url: be, type: bf, dataType: "html", data: bh, complete: function (bk, bj, bl) {
            bl = bk.responseText;
            if (bk.isResolved()) {
                bk.done(function (bm) {
                    bl = bm
        ...
        return this.map(function () {
            ...
            return be == null ? null : a.isArray(be) ? a.map(be, function (bg, bf) {
                return{name: bd.name, value: bg.replace(bc, "\r\n")}
    ...
    a.each(["get", "post"], function (e, bd) {
        a[bd] = function (be, bg, bh, bf) {
            ...
            return a.ajax({type: bd, url: be, data: bg, success: bh, dataType: bf})
        }
    });
    a.extend({getScript: function (e, bd) {
        ...
        return be
    }, ajaxSettings: {url: au, isLocal: aB.test(r[1]), global: true, type: "GET", contentType: "application/x-www-form-urlencoded", processData: true, async: true, accepts: {xml: "application/xml, text/xml", html: "text/html", text: "text/plain", json: "application/json, text/javascript", "*": "*/*"}, contents: {xml: /xml/, html: /html/, json: /json/}, responseFields: {xml: "responseXML", text: "responseText"}, converters: {"* text": aY.String, "text html": true, "text json": a.parseJSON, "text xml": a.parseXML}}, ajaxPrefilter: d(V), ajaxTransport: d(q), ajax: function (bh, bf) {
        if (typeof bh === "object") {
            bf = bh;
            bh = H
        }
        bf = bf || {};
        var bl = a.ajaxSetup({}, bf), bz = bl.context || bl, bo = bz !== bl && (bz.nodeType || bz instanceof a) ? a(bz) : a.event, by = a.Deferred(), bv = a._Deferred(), bj = bl.statusCode || {}, bk, bp = {}, bx, bg, bt, bm, bq, bi = 0, be, bs, br = {readyState: 0, setRequestHeader: function (e, bA) {
            if (!bi) {
        ...
        if (!bl.hasContent) {
            ...
            bk = bl.url;
            if (bl.cache === false) {
                var bd = a.now(), bw = bl.url.replace(bb, "$1_=" + bd);
        ...
        for (bs in {success: 1, error: 1, complete: 1}) {
            br[bs](bl[bs])
        }
        bt = aI(q, bl, bf, br);
        if (!bt) {
    ...
    a.fn.extend({show: function (bf, bi, bh) {
        var be, bg;
        if (bf || bf === 0) {
    ...
    }, _toggle: a.fn.toggle, toggle: function (be, bd, bf) {
        ...
        return this.filter(":hidden").css("opacity", 0).show().end().animate({opacity: bf}, e, be, bd)
        ...
        return this[e.queue === false ? "each" : "queue"](function () {
            ...
            a.each(bg, function (bp, bt) {
                ...
                if (ap.test(bt)) {
                    ...
                    var br = aF.exec(bt), bu = bs.cur();
                    if (br) {
                        var bo = parseFloat(br[2]), bq = br[3] || (a.cssNumber[bp] ? "" : "px");
                        if (bq !== "px") {
    ...
    a.each({slideDown: aQ("show", 1), slideUp: aQ("hide", 1), slideToggle: aQ("toggle", 1), fadeIn: {opacity: "show"}, fadeOut: {opacity: "hide"}, fadeToggle: {opacity: "toggle"}}, function (e, bd) {
        a.fn[e] = function (be, bg, bf) {
            return this.animate(bd, be, bg, bf)
        }
    });
    a.extend({speed: function (be, bf, bd) {
        var e = be && typeof be === "object" ? a.extend({}, be) : {complete: bd || !bd && bf || a.isFunction(be) && be, duration: be, easing: bd && bf || bf && !a.isFunction(bf) && bf};
    ...
    if ("getBoundingClientRect" in al.documentElement) {
        a.fn.offset = function (bq) {
            ...
            if (!bj || !a.contains(be, bg)) {
                return bj ? {top: bj.top, left: bj.left} : {top: 0, left: 0}
            }
    ...
    a.fn.extend({position: function () {
        ...
        var be = this[0], bd = this.offsetParent(), bf = this.offset(), e = Y.test(bd[0].nodeName) ? {top: 0, left: 0} : bd.offset();
        ...
        return{top: bf.top - e.top, left: bf.left - e.left}
